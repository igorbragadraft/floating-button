const WEBHOOK_URL =
  "https://sistema.coroadefloresnobre.com.br/api/webhooks/whatsapp-form";

const whatsAppGtmTrigger = document.getElementById("wf8731WhatsAppGtmTrigger");
const phone0800GtmTrigger = document.getElementById(
  "wf8731Phone0800GtmTrigger",
);
const phone3003GtmTrigger = document.getElementById(
  "wf8731Phone3003GtmTrigger",
);
...
const campaignDataInput = document.querySelector(
  'input[name="87_campaign_data_31_waform"]',
);
const sourceDataInput = document.querySelector(
  'input[name="87_source_data_31_waform"]',
);
  ...
  if (!chatModal.classList.contains("wf8731-active")) {
    ...
    if (triggerType.includes("phone")) {
      ...
      welcomeMessage.innerText =
        "Estamos disponíveis 24 horas! ✅ Preencha os campos abaixo e ligue para nós agora mesmo para garantir a sua homenagem 💚";
      submitBtn.querySelector(".wf8731-btn-text").innerText = "Ligar agora";
    } else {
      whatsappInput.placeholder = "Número do WhatsApp";
      welcomeMessage.innerText =
        "Estamos disponíveis 24 horas! ✅ Preencha os campos abaixo para iniciar uma conversa com um de nossos consultores e garantir a sua homenagem 💚";
      submitBtn.querySelector(".wf8731-btn-text").innerText =
        "Iniciar Conversa";
    }
...
whatsappButton.addEventListener("click", () =>
  openWf8731Modal("floating_button"),
);
...
contactForm.addEventListener("submit", async (e) => {
  ...
  try {
    ...
    successMessage.innerText =
      "✨ Em poucos segundos você terá um consultor nosso cuidando de tudo por você.";
    ...
    if (formData.formId.includes("phone_3003")) {
      ...
      window.open(
        "https://api.whatsapp.com/send?phone=558000020001&text=Ol%C3%A1%2C%20vim%20do%20site%20e%20estou%20precisando%20de%20uma%20coroa%20de%20flores!",
      );
...
setTimeout(() => {
  if (
    !chatModal.classList.contains("wf8731-active") &&
    !successMessage.classList.contains("wf8731-show")
  ) {
    badge.style.display = "flex";
    badge.style.animation = "wf8731-badgePop 0.3s ease-out";
  }
...
function handleFooterLinks(footer) {
  ...
  footerLinks.forEach((link) => {
    link.addEventListener("click", function (e) {
      ...
      if (innerText.includes("whatsapp"))
        window.openWf8731Modal("footer_whatsapp");
      else if (innerText.includes("3003"))
        window.openWf8731Modal("footer_phone_3003");
      else if (innerText.includes("0800"))
        window.openWf8731Modal("footer_phone_0800");
    });
  });
}
